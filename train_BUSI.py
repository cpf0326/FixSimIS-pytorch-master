...
from dataset.breastSet import DATASET_GETTERS, get_breast
...
def train(args, labeled_trainloader, unlabeled_trainloader, test_loader,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for batch_idx in range(args.eval_step):
            ...
            triplet_loss=torch.nn.TripletMarginLoss(margin=1.0, p=2.0, eps=1e-06, swap=False, size_average=None, reduce=None,
                                       reduction='mean')
            ...
            loss = Lx + args.lambda_u * Lu+0.1*trip_loss
