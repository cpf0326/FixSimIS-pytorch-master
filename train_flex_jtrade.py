...
def get_cosine_scheduler_with_warmupFlex(optimizer, T_max, num_cycles=7. / 16., num_warmup_steps=0,
                                     last_epoch=-1):
    """
...
def main():
    ...
    optimizer = optim.SGD(grouped_parameters, lr=args.lr,
                          momentum=0.9, weight_decay=args.wdecay, nesterov=args.nesterov)

    args.epochs = math.ceil(args.total_steps / args.eval_step)
    scheduler = get_cosine_scheduler_with_warmupFlex(
        optimizer, args.epochs * args.eval_step)
...
def train(args, labeled_trainloader, unlabeled_trainloader, test_loader,
    ...
    selected_label = selected_label.cuda(args.gpu_id)
